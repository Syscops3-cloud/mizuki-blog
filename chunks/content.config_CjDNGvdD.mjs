import { b as slash, e as pLimit, C as CONTENT_LAYER_TYPE, L as LIVE_CONTENT_TYPE, d as defineCollection } from './_astro_content_nJCuh7Be.mjs';
import path__default, { relative as relative$1 } from 'node:path';
import { fileURLToPath as fileURLToPath$1, pathToFileURL } from 'node:url';
import { x as commonjsGlobal, y as getDefaultExportFromCjs, z as s, o as objectType, s as stringType, B as unionType, j as arrayType, C as recordType, D as anyType, E as literalType, i as booleanType, G as functionType, H as tupleType, I as unknownType, k as dateType } from './astro/server_CFIJpBV_.mjs';
import path, { sep, basename, dirname, resolve, normalize, relative, posix } from 'path';
import './_astro_assets_CT7LrGpm.mjs';
...
function getRelativeEntryPath(entry, collection, contentDir) {
  const relativeToContent = path__default.relative(fileURLToPath$1(contentDir), fileURLToPath$1(entry));
