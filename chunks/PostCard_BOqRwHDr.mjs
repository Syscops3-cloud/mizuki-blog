import { c as createComponent, a as createAstro, h as defineStyleVars, m as maybeRenderHead, b as addAttribute, e as renderComponent, d as renderTemplate } from './astro/server_CFIJpBV_.mjs';
import { r as renderEntry, I as I18nKey } from './_astro_content_nJCuh7Be.mjs';
import { a as $$Icon, b as $$ImageWrapper } from './MainGridLayout_CN5EEUhk.mjs';
import { h as getTagUrl, i as i18n, e as getFileDirFromPath } from './sakura-manager_BcW8Ox11.mjs';
...
const $$PostCard = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div${addAttribute(["card-base flex flex-col-reverse md:flex-col w-full rounded-[var(--radius-large)] overflow-hidden relative", className], "class:list")}${addAttribute(`${style}; ${$$definedVars}`, "style")} data-astro-cid-iyiqi2so> <div${addAttribute(["pl-6 md:pl-9 pr-6 md:pr-2 pt-6 md:pt-7 pb-6 relative", { "w-full md:w-[calc(100%_-_52px_-_12px)]": !hasCover, "w-full md:w-[calc(100%_-_var(--coverWidth)_-_12px)]": hasCover }], "class:list")} data-astro-cid-iyiqi2so${addAttribute($$definedVars, "style")}> <a${addAttribute(url, "href")} class="transition group w-full block font-bold mb-3 text-3xl text-90
        ...
        " data-astro-cid-iyiqi2so${addAttribute($$definedVars, "style")}> ${pinned && renderTemplate`${renderComponent($$result, "Icon", $$Icon, { "name": "mdi:pin", "class": "inline text-[var(--primary)] text-2xl mr-2 -translate-y-0.5", "data-astro-cid-iyiqi2so": true })}`} ${title} ${renderComponent($$result, "Icon", $$Icon, { "class": "inline text-[2rem] text-[var(--primary)] md:hidden translate-y-0.5 absolute", "name": "material-symbols:chevron-right-rounded", "data-astro-cid-iyiqi2so": true })} ${renderComponent($$result, "Icon", $$Icon, { "class": "text-[var(--primary)] text-[2rem] transition hidden md:inline absolute translate-y-0.5 opacity-0 group-hover:opacity-100 -translate-x-1 group-hover:translate-x-0", "name": "material-symbols:chevron-right-rounded", "data-astro-cid-iyiqi2so": true })} </a> <!-- metadata (without tags) --> ${renderComponent($$result, "PostMetadata", $$PostMeta, { "published": published, "updated": updated, "tags": tags, "category": category || "", "hideTagsForMobile": true, "hideUpdateDate": true, "className": "mb-4", "showOnlyBasicMeta": true, "words": remarkPluginFrontmatter.words, "showWordCount": true, "data-astro-cid-iyiqi2so": true })} <!-- description --> <div${addAttribute(["transition text-75 mb-3.5 pr-4", { "line-clamp-2 md:line-clamp-1": !description }], "class:list")} data-astro-cid-iyiqi2so${addAttribute($$definedVars, "style")}> ${description || remarkPluginFrontmatter.excerpt} </div> <!-- tags (moved to bottom) --> <div class="flex flex-wrap gap-2 mt-2" data-astro-cid-iyiqi2so${addAttribute($$definedVars, "style")}> ${tags && tags.length > 0 ? tags.map((tag) => renderTemplate`<a${addAttribute(getTagUrl(tag), "href")}${addAttribute([
    "btn-regular h-6 text-xs px-2 rounded-lg"
  ], "class:list")}${addAttribute(`View all posts tagged with ${tag.trim()}`, "aria-label")} data-astro-cid-iyiqi2so${addAttribute($$definedVars, "style")}> <span class="transition-transform group-hover/tag:translate-x-0.5" data-astro-cid-iyiqi2so${addAttribute($$definedVars, "style")}>
# ${tag.trim()} </span> </a>`) : renderTemplate`<span class="text-xs text-50" data-astro-cid-iyiqi2so${addAttribute($$definedVars, "style")}>${i18n(I18nKey.noTags)}</span>`} </div> </div> ${hasCover && renderTemplate`<a${addAttribute(url, "href")}${addAttribute(title, "aria-label")}${addAttribute([
    "group",
...
}, "D:/lyf/blog/my_blog/src/components/PostCard.astro", void 0);
